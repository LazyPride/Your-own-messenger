...
insert into envelope (id, address_from, address_to, interlocutor_id)
    values
        (1, '0xAddress', '0xacab', 1),
        (2, '0xacab', '0xAddress', 1),
        (3, '0xAddress', '0xacab', 1),
        (4, '0xacab', '0xAddress', 1),

        (5, '0xAddress', '0xcabaddadad', 2),
        (6, '0xcabaddadad', '0xAddress', 2),

        (7, '0xhi_there', '0x241d1s14', 3),
        (8, '0x241d1s14', '0xhi_there', 3),
        (9, '0xhi_there', '0x241d1s14', 3);
